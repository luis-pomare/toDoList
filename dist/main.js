...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_readDom_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/readDom.js */ \"./src/modules/readDom.js\");\n/* harmony import */ var _modules_itemFunctions_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/itemFunctions.js */ \"./src/modules/itemFunctions.js\");\n\r\n\r\n\r\n\r\nlet list = [];\r\nlet index = 0;\r\n\r\nif (JSON.parse(localStorage.getItem(\"listArray\")) !== null) {\r\n  list = JSON.parse(localStorage.getItem(\"listArray\"));\r\n  index = list.length;\r\n}\r\n\r\nclass Item {\r\n  constructor(description, completed, index) {\r\n    this.description = description;\r\n    this.completed = completed;\r\n    this.index = index;\r\n  }\r\n}\r\n\r\n// To clear the input field each time the enter button is clicked\r\nfunction clearInput() {\r\n  _modules_readDom_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].taskInput.value = \"\";\r\n}\r\n\r\nfunction storageNewElement() {\r\n  const element = new Item(_modules_readDom_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].taskInput.value, false, index);\r\n  list.push(element);\r\n  index += 1;\r\n  localStorage.setItem(\"listArray\", JSON.stringify(list));\r\n}\r\n\r\n_modules_readDom_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].enterIcon.addEventListener(\"click\", () => {\r\n  if (_modules_readDom_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].taskInput.value !== \"\") {\r\n    (0,_modules_itemFunctions_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(_modules_readDom_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].taskInput.value, index, false);\r\n    storageNewElement();\r\n    clearInput();\r\n  }\r\n});\r\n\r\nfunction renderList() {\r\n  _modules_readDom_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].ul.innerHTML = \"\";\r\n  for (let i = 0; i < list.length; i += 1) {\r\n    (0,_modules_itemFunctions_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(list[i].description, list[i].index, list[i].completed);\r\n  }\r\n}\r\n\r\n// Initial rendering\r\nrenderList();\r\n\r\nfunction clearCompleted() {\r\n  list = list.filter((item) => item.completed === false);\r\n  index = list.length;\r\n  for (let i = 0; i < index; i += 1) {\r\n    list[i].index = i;\r\n  }\r\n  localStorage.setItem(\"listArray\", JSON.stringify(list));\r\n  renderList();\r\n}\r\n\r\n_modules_readDom_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].clearCompletedButton.addEventListener(\"click\", () => {\r\n  clearCompleted();\r\n});\r\n\r\n_modules_readDom_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].ul.addEventListener(\"click\", (e) => {\r\n  if (e.target) {\r\n    if (e.target.type === \"checkbox\") {\r\n      e.target.parentElement.classList.toggle(\"checked\");\r\n      list[e.target.dataset.index].completed = e.target.checked;\r\n      localStorage.setItem(\"listArray\", JSON.stringify(list));\r\n    }\r\n    if (e.target.tagName === \"I\") {\r\n      const numericIndex = Number(e.target.dataset.index);\r\n      list = list.filter((item) => item.index !== numericIndex);\r\n      index = list.length;\r\n      for (let i = 0; i < index; i += 1) {\r\n        list[i].index = i;\r\n      }\r\n      localStorage.setItem(\"listArray\", JSON.stringify(list));\r\n      renderList();\r\n    }\r\n    if (e.target.tagName === \"P\") {\r\n      e.target.innerHTML = `<input type=text data-index=${e.target.dataset.index} >`;\r\n    }\r\n  }\r\n});\r\n\r\n_modules_readDom_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].ul.addEventListener(\"change\", (e) => {\r\n  if (e.target.type === \"text\") {\r\n    e.target.parentElement.innerHTML = `<p>${e.target.value}</p>`;\r\n    list[e.target.dataset.index].description = e.target.value;\r\n    localStorage.setItem(\"listArray\", JSON.stringify(list));\r\n  }\r\n});\r\n\n\n//# sourceURL=webpack://webpacktemplate/./src/index.js?");

/***/ }),

/***/ "./src/modules/itemFunctions.js":
/*!**************************************!*\
  !*** ./src/modules/itemFunctions.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _readDom_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./readDom.js */ \"./src/modules/readDom.js\");\n\r\n\r\nconst renderElement = function (description, index, checked) {\r\n  let isChecked = \"\";\r\n  let checkedClass = \"\";\r\n  if (checked === true) {\r\n    isChecked = \"checked=true\";\r\n    checkedClass = \"checked\";\r\n  }\r\n  const element = `\r\n        <li class=\"flexItem\">\r\n          <span class=\"${checkedClass}\">\r\n            <input type=\"checkbox\" class=\"checkbox\" data-index=${index} ${isChecked}>\r\n            <p data-index=${index}>${description}</p>\r\n          </span>\r\n          <span>\r\n          <i class=\"fa-solid fa-trash-can\" data-index=${index}></i>\r\n          </span>\r\n        </li>      \r\n      `;\r\n  _readDom_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].ul.innerHTML += element;\r\n};\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (renderElement);\r\n\n\n//# sourceURL=webpack://webpacktemplate/./src/modules/itemFunctions.js?");

/***/ }),

/***/ "./src/modules/readDom.js":
/*!********************************!*\
  !*** ./src/modules/readDom.js ***!
  \********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n// Dom elements object\r\nclass DomObject {\r\n  // Read elements from document\r\n  taskInput = document.getElementById(\"taskInput\");\r\n  enterIcon = document.getElementById(\"enterIcon\");\r\n  ul = document.getElementById(\"listContainer\");\r\n  clearCompletedButton = document.getElementById(\"clearCompleted\");\r\n}\r\nconst domObject = new DomObject();\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (domObject);\r\n\n\n//# sourceURL=webpack://webpacktemplate/./src/modules/readDom.js?");
